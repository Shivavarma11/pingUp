    ...
    <div className='relative h-full overflow-y-scroll bg-gray-50 p-6'>
      <div className='max-w-3xl mx-auto'>
        ...
        <div className='bg-white rounded-2xl shadow overflow-hidden'>
          {/* Cover Photo */}
          <div className='h-40 md:h-56 bg-linear-to-r from-indigo-200
          via-purple-200 to-pink-200'>
            {user.cover_photo && <img src={user.cover_photo} alt='' className='w-full h-full object-cover'></img>}
                    ...
                    <>
                      {
                        post.image_urls.map((image,index)=>(
                          ...
                          className='relative group'>
                            <img src={image} alt="" key={index} className='w-64 aspect-video
                            object-cover' />
