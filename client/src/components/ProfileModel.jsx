...
const ProfileModel = ({ setShowEdit }) => {
    ...
    overflow-y-scroll bg-black/50'>
            <div className='max-w-2xl sm:sp-6 mx-auto'>
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={e => toast.promise(
                        ...
                        font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative'>
                                    <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture)
                                        : user.profile_picture} alt="" className='w-24 h-24 rounded-full object-cover mt-2' />
                            ...
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/cover relative'>
                                    <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo)
                                        ...
                                        className='w-80 h-40 rounded-lg bg-linear-to-r
                                    from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2'/>
                        ...
                        rounded-lg' placeholder='Please enter your full name' onChange={(e) => setEditForm({ ...editForm, full_name: e.target.value })}
                        ...
                        <div>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200
                        rounded-lg' placeholder='Please enter your username' onChange={(e) => setEditForm({ ...editForm, username: e.target.value })}
                        ...
                        rounded-lg' placeholder='Please enter short bio' onChange={(e) => setEditForm({ ...editForm, bio: e.target.value })}
                                value={editForm.bio} />
                        </div>
                        <div>
                            <label className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <input type="text" className='w-full p-3 border border-gray-200
                        rounded-lg' placeholder='Please enter your location' onChange={(e) => setEditForm({ ...editForm, location: e.target.value })}
                        ...
                        text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Cancel</button>
                            ...
                            <button type='submit' className='px-4 py-2 bg-linear-to-r
