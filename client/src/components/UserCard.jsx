    ...
    shadow border border-gray-200 rounded-md'>
            ...
            <div className='flex mt-4 gap-2'>
                ...
                <button onClick={handleFollow} disabled={currentUser?.following.includes(user._id)}
                 ...
                 items-center gap-2 bg-linear-to-r from-indigo-500 to-purple-600
                 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition
                 text-white cursor-pointer'>
                    <UserPlus className='w-4 h-4' />{currentUser?.following.includes(user._id) ? 'Follwing' : 'Follow'}
                </button>
                ...
                cursor-pointer active:scale-95 transition'>
                    {
                        ...
                        :
                        <Plus className='w-5 h-5 group-hover:scale-105 transotion'/>
