            ...
            if (file.type.startsWith('video')) {
                ...
                video.onloadedmetadata = () => {
                    ...
                    if (video.duration > MAX_VIDEO_DURATION) {
                        toast.error('Video duration connot exceed 1 minute.')
                        setMedia(null)
                        setPreviewUrl(null)
                    } else {
                        setMedia(file)
    ...
    text-white flex items-center justify-center p-4'>
            ...
            relative' style={{ backgroundColor: background }}>
                    ...
                    )}
                    {
                        mode === 'media' && previewUrl && (
                            media?.type.startsWith('image') ? (
                                ...
                                <video src={previewUrl} alt="" className='object-contain max-h-full' />
                            )
                        )
                    }
                ...
                <div className='flex gap-2 mt-4'>
                    ...
                    }} className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer ${mode === 'text' ? "bg-white text-black" : "bg-sinc-800"}`}>
                ...
                py-3 wt-4 w-full rounded bg-linear-to-r from-indigo-500 to-purple-600
