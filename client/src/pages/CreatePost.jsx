                ...
                images.map((image,i)=>(
                  <div key={i} className='relative group'>
                    ...
                    <div onClick={()=>setImages(images.filter((_,index)=>index!==i))}
                      ...
                      justify-center items-center top-0 right-0 borrom-0 left-0
